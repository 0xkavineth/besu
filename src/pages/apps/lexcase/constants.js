...
export const STR = {
  ...
  retroModeOn: { th: "Retro", en: "Retro" },
  retroModeOff: { th: "ปกติ", en: "Normal" },
  switchToRetro: { th: "สลับเป็นโหมด Retro", en: "Switch to Retro mode" },
  switchToNormal: { th: "สลับเป็นโหมดปกติ", en: "Switch to Normal mode" },
